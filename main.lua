function love.load()
	...
	-- sound effects (static-(loaded entirely in the memory)) music (stream)
	...
	--specifying what data we want saved
	--we can also save player positions using px, py and :getPosition
	saveData = {}
...
function love.draw()
	-- huds or layouts go outside the cam scroll
